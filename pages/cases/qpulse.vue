...
import CsFeaturedSectionWithEmbeddedVideo from '~/components/Sections/Cases/CsFeaturedSectionWithEmbeddedVideo.vue'
  ...
  computed: {
    ...
    componentMap() {
      return {
        ...
        'cs_team': CsTeam,
        'cs-result': CsResult,
        'cs_featured_section_with_embedded_video': CsFeaturedSectionWithEmbeddedVideo,
