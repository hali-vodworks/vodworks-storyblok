...
import CsApproachWithCards from '~/components/Sections/Cases/CsEaSportsApproachWithCards.vue'
import CsTechStack from '~/components/Sections/Cases/CsTechStack.vue'
import CsServicesWeProvide from '~/components/Sections/Cases/CsServicesWeProvide.vue'
  ...
  computed: {
    ...
    componentMap() {
      return {
        ...
        'services_we_provided': CsServicesWeProvide,
